...
def check_dimension(dimension, transform=None):
    ...
    Parameters
    ----------
    dimension : Dimension, tuple, or list
        Description of the dimension. Can be:
        - A Dimension instance (will be returned as-is)
        - A tuple for creating Real, Integer, or Categorical dimensions
        - A list of dimension specifications
