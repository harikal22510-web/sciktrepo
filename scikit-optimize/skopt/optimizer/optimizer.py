...
class Optimizer(object):
    """Run bayesian optimisation loop with enhanced error handling and validation.
    ...
    Use this class directly if you want to control iterations of your
    ...
    base_estimator : string or regressor, default="gp"
        Should inherit from `sklearn.base.RegressorMixin`.
        If string, it should be one of:
        - "GP", Gaussian process regressor (default)
        - "RF", Random forest regressor
        - "ET", Extra trees regressor
        - "GBRT", Gradient boosting trees regressor
        - "DUMMY", Dummy regressor (for testing)
